...
export function Room() {
  ...
  async function handleSendQuestion(event: FormEvent) {
    ...
    const question = {
      ...
      // destaque que o admin da para a pergunta que está sendo respondida atualmente
      isHighLighted: false,
      // determina se a pergunta foi respondida ou não
      isAnswered: false,
    };
                ...
                {!question.isAnswered && (
                  ...
                  >
                    {question.likeCount > 0 && (
                      <span id="span-button">{question.likeCount}</span>
                    )}
                    <svg
                      width="24"
                      height="24"
